...
paste(datos[datos$buy == 1,]$nationality, collapse=", ") # Países de jugadores comprados

# Ejercicio: ¿Qué pasa si bajamos la restricción presupuestal a 400 millones? ¿A 200?
# RTA: hay que modificar la restriccion presupuestal en la línea 104

# Ejercicio: ¿Cuál es el resultado si queremos el equipo con la mayor edad total posible (no a menor)?
# RTA: hay que min por max en la línea 122